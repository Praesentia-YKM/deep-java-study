package lamdaStreamOptional.lambda.lambda5.mystream;

import lamdaStreamOptional.lambda.lambda5.filter.GenericFilter;
import lamdaStreamOptional.lambda.lambda5.map.GenericMapper;
...
public class Ex2_Student {
    ...
    private static List<String> lambda(List<Student> students) {
        ...
        return mapped;
//        List<String> result = GenericMapper.map(students, s -> {
//            // 필터 조건을 map 함수 내에 포함
//            if (s.getScore() >= 80) {
//                return s.getName();
//            }
...
//        });
//
//        result.removeIf(name -> name == null);
//        return result;
    }
}