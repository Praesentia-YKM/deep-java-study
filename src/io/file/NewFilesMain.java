...
/**
 * Files는 파일관련 유틸리티 메서드
 * File은 옛날 방식 파일,디렉토리 관리 객체
 * Path는 파일이나 디렉토리의 경로 표현하고 이를 바탕으로 파일 작업을 할 수 있음 NIO2 api
 */
...
//        // 9. move(): 파일의 이름을 변경하거나 이동
          Path newFile = Paths.get("temp/newExample.txt");// == Path.of("temp/newExample.txt") 와 같ㅇ므
        System.out.println(newFile);
          Files.move(file, newFile, StandardCopyOption.REPLACE_EXISTING); // 현재있는거 교체하는 옵션
