...
public class BasicData {
    ...
    private BasicData(String data,String data2,String data3) {
        System.out.println("BasicData.BasicData: " + data + data2 + data3);
    }
    ...
    private static Integer staticMethod(Integer i) {
        System.out.println("BasicData.staticMethod");
        return i;
    }
}
